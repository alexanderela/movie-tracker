        ...
        <div className="card-inner-wrapper">
          <h3 className="movie-title">
            <div className="movie-rating">
              {!expanded && <div>Rating {movie.rating}</div>}
            </div>
            {movie.title}
            <button
              ...
              <img
                className="card-favorite-button-star"
                alt=""
                src={movie.favorite ? filledStar : star}
              />
            </button>
          </h3>
          <div className="expanded-lower-container">
            <img src={movie.poster} alt="" className="poster-image" />
            <div className="lower-middle-expanded">
              ...
              {expanded && (
                <div className="rating-container">
                  <div className="rating-bar" style={ratingStyles}>
                    {movie.rating} / 10
                  </div>
                </div>
              )}
